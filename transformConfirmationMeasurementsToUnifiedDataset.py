...
import pandas as pd
import glob
from SETTINGS import CONFIRMATION_MEASUREMENTS_FOLDER, PRESSURE_FILE_PREFIX, WIFI_FILE_PREFIX, \
    UNI_WIFI_BSSID_REGEX_PATTERN, SSID_EXCLUDE_REGEX_PATTERN, CONFIRMATION_MEASUREMENT_EXPORT_FILE_NAME
...
if __name__ == "__main__":
    ...
    for measurement_series_name in os.listdir(CONFIRMATION_MEASUREMENTS_FOLDER):
        measurement_series_directory = os.path.join(CONFIRMATION_MEASUREMENTS_FOLDER, os.fsencode(measurement_series_name))
    ...
    master_df.to_csv(CONFIRMATION_MEASUREMENT_EXPORT_FILE_NAME)
